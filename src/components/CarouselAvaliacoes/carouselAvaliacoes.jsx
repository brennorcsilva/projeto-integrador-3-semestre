...
const CarouselAvaliacoes = () =>{
    return(
        ...
        >
            ...
            <div className="container-avaliacao flex justify-center items-center">
                <img src={ imgAvaliacao} alt="imagem de usuario avaliacao"/>
                <div className="container-texto">
                    <h1>Douglas Vieira dos Santos, 27 anos</h1>
                    <p>Eu fui um dos primeiros a utilizar o CONEXSP. Realizei uma doação de plaquetas. A agilidade em comparação com outros sistemas é realmente gritante!</p>
                </div>
            </div>
